...
- **`MCENGINE_GITHUB_TOKEN_PKG_PUBLISH_ADDON`** – Token used to publish the PKG to the [`AddOn`](https://github.com/orgs/MCEngine/packages?repo_name=addon) repository. This token is only valid for the [`AddOn`](https://github.com/MCEngine/addon) repository.
